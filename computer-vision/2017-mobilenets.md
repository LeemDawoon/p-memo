...
![Figure 2. The standard convolutional filters in \(a\) are replaced by two layers: depthwise convolution in \(b\) and pointwise convolution in \(c\) to build a depthwise separable filter.](../.gitbook/assets/image%20%2883%29.png)
...
![&#xC2DD;\(1\)&#xC758;  computational cost ](../.gitbook/assets/image%20%2898%29.png)
