...
* ![](../.gitbook/assets/image%20%2839%29.png): i-th 셀에 물체가 있으면 1 아니면 0
* ![](../.gitbook/assets/image%20%2810%29.png): i-th 셀에 물체가 있고, j-th box predictor 값이 i-th 셀의 다른 것보다 높으면 1
  * 헷갈리지 말것은 j-th 한 그리드내 박스에 관한 것. 
  * B=2일 경우, j는 박스 2개중의 하나.
* ![](../.gitbook/assets/image%20%2822%29.png): i-th 셀에 물체가 고, j-th box predictor 값이 i-th 셀의 다른 것보다 낮면 1
